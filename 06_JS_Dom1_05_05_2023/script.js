...
// var 
// let; переменные, могут быть переприсвоены
...
const newPText = document.createTextNode("This text new !!!!");
...
const newP2Text = document.createTextNode("This a new text p2 _____");
